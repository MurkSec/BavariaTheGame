...
class Graphics_Engine:
  ...
  def InitImages(self):
    ...
    self.Tprint("    /  /    \/ /\     \    /    \ \  /   |'|""`""|'|   /  \/  \  /    \ ")
    self.Tprint("   /  /      \/  \/\   \  /      \       | | /^\ | |                    ")
    self.Tprint("__/__/_______/___/__\___\________________|_|_|I|_|_|____________________")
    ...
    self.Tprint(' ')
    self.Tprint("                                             _______________________      ")
    self.Tprint("   _______________________-------------------                       `\    ")
    self.Tprint(" /:--__                                                              |    ")
    self.Tprint("||< > |                                   ___________________________/    ")
    self.Tprint("| \__/_________________-------------------                         |      ")
    self.Tprint("|                                                                  |      ")
    self.Tprint(" |                       Some kind of origin story                  |     ")
    self.Tprint(" |                                                                  |     ")
    self.Tprint(" |       Three Rings for the Elven-kings under the sky,             |     ")
    self.Tprint("  |        Seven for the Dwarf-lords in their halls of stone,        |    ")
    self.Tprint("  |      Nine for Mortal Men doomed to die,                          |    ")
    self.Tprint("  |        One for the Dark Lord on his dark throne                  |    ")
    self.Tprint("  |      In the Land of Mordor where the Shadows lie.                |    ")
    self.Tprint("   |       One Ring to rule them all, One Ring to find them,          |   ")
    self.Tprint("   |       One Ring to bring them all and in the darkness bind them   |   ")
    self.Tprint("   |     In the Land of Mordor where the Shadows lie.                 |   ")
    self.Tprint("    |                                              ____________________|_ ")
    self.Tprint("    |  ___________________-------------------------                      `\ ")
    self.Tprint("    |/`--_                                                                 | ")
    self.Tprint("    ||[ ]||                                            ___________________/ ")
    self.Tprint("     \===/___________________--------------------------                    ")
